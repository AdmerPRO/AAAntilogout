...
public record PluginSettings(
    ...
    public static PluginSettings load(JavaPlugin plugin) {
        ...
        return new PluginSettings(
            ...
            Math.max(1, config.getInt("combat.duration-seconds", 30)),
            config.getBoolean("combat.refresh-timer-on-hit", true),
            config.getBoolean("combat.ignore-creative-spectator", true),
            ...
            config.getBoolean("regions.prevent-tagging-inside-blocked-region", true),
